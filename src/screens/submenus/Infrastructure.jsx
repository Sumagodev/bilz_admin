...
const Infrastructure = () => {
  ...
  const fetchTeam = async () => {
    ...
    try {
      const response = await instance.get("exhibition/find", {
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm(formData)) {
      ...
      try {
        if (editMode) {
          await instance.put(`exhibition/update/${editingId}`, data, {
            headers: {
              Authorization: "Bearer " + accessToken,
          ...
          await instance.post("exhibition/add", data, {
            headers: {
              Authorization: "Bearer " + accessToken,
              "Content-Type": "multipart/form-data",
            },
          ...
          >
            <button
              ...
              onClick={async () => {
                ...
                try {
                  await instance.delete(`exhibition/isdelete/${id}`, {
                    headers: {
                      Authorization: `Bearer ${accessToken}`,
                      "Content-Type": "application/json",
                    },

...
const Testimonial = () => {
  ...
  const fetchTeam = async () => {
    ...
    try {
      const response = await instance.get("About/get", {
        headers: {
  ...
  //     try {
  //       if (editMode) {
  //         await instance.put(`About/update-About/${editingId}`, data, {
  //           headers: {
  //             Authorization: "Bearer " + accessToken,
  ...
  //       } else {
  //         await instance.post("About/create-About", data, {
  //           headers: {
  //             Authorization: "Bearer " + accessToken,
  //             "Content-Type": "multipart/form-data",
  //           },
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm(formData)) {
      ...
      try {
        if (editMode) {
          await instance.put(`About/update/${editingId}`, data, {
            headers: {
              Authorization: "Bearer " + accessToken,
              "Content-Type": "multipart/form-data",
            },
          ...
          await instance.post("About/add", data, {
            headers: {
              Authorization: "Bearer " + accessToken,
              "Content-Type": "multipart/form-data",
            },
          ...
          >
            <button
              ...
              onClick={async () => {
                ...
                try {
                  await instance.delete(`About/isdelete/${id}`, {
                    headers: {
                      Authorization: `Bearer ${accessToken}`,
                      "Content-Type": "application/json",
                    },

...
const Analysis = () => {
  ...
  const fetchTeam = async () => {
    ...
    try {
      const response = await instance.get("v_analysis/find", {
        headers: {
    ...
    if (validateForm(formData)) {
      ...
      try {
        if (editMode) {
          ...
          await instance.put(`v_analysis/update/${editingId}`, data, {
            headers: {
              Authorization: "Bearer " + accessToken,
              "Content-Type": "application/json",
            },
          ...
          // Add a new record
          await instance.post("v_analysis/add", data, {
            headers: {
              Authorization: "Bearer " + accessToken,
          ...
          <div className="confirm-alert-buttons">
            <Button
              ...
              onClick={async () => {
                ...
                const accessToken = localStorage.getItem("accessToken");
                try {
                  await instance.delete(`v_analysis/isdelete/${id}`, {
                    headers: {
                      Authorization: `Bearer ${accessToken}`,
                      "Content-Type": "application/json",
                    },
          ...
          <div className="confirm-alert-buttons">
            <Button
              ...
              onClick={async () => {
                ...
                const accessToken = localStorage.getItem("accessToken");
                try {
                  await instance.put(`v_analysis/isactive/${id}`, { isActive }, {
                    headers: {
                      Authorization: `Bearer ${accessToken}`,
                      "Content-Type": "application/json",
                    },

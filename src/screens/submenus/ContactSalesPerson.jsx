...
const ContactSalesPerson = () => {
  ...
  const fetchTeam = async () => {
    ...
    try {
      const response = await instance.get("contact_us/find", {
        headers: {
  ...
  const validateForm = (formData) => {
    ...
    if (!formData.solution?.trim()) {
      errors.title = "Solution is required";
    }
    if (!formData.surname?.trim()) {
      errors.title = "Surname is required";
    }
    if (!formData.street?.trim()) {
      errors.title = "street is required";
    }
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm(formData)) {
      ...
      try {
        if (editMode) {
          await instance.put(`contact_us/update/${editingId}`, data, {
            headers: {
              Authorization: "Bearer " + accessToken,
          ...
          await instance.post("contact_us/add", data, {
            headers: {
              Authorization: "Bearer " + accessToken,
              "Content-Type": "multipart/form-data",
            },
          ...
          >
            <button
              ...
              onClick={async () => {
                ...
                const accessToken = localStorage.getItem("accessToken");
                try {
                  await instance.delete(`contact_us/isdelete/${id}`, {
                    headers: {
                      Authorization: `Bearer ${accessToken}`,
                      "Content-Type": "application/json",
                    },

...
const HomeSlider = () => {
  ...
  const fetchTeam = async () => {
    ...
    try {
      const response = await instance.get("carrousel/find", {
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm(formData)) {
      ...
      try {
        if (editMode) {
          await instance.put(`carrousel/update/${editingId}`, data, {
            headers: {
              Authorization: "Bearer " + accessToken,
          ...
          await instance.post("carrousel/add", data, {
            headers: {
              Authorization: "Bearer " + accessToken,
              "Content-Type": "multipart/form-data",
            },
          ...
          >
            <button
              ...
              onClick={async () => {
                ...
                try {
                  await instance.delete(`carrousel/isdelete/${id}`, {
                    headers: {
                      Authorization: `Bearer ${accessToken}`,
                      "Content-Type": "application/json",
                    },

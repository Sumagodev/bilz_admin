    ...
    },
{
  ...
  const fetchTeam = async () => {
    ...
    try {
      const response = await instance.get("apply_now/find", {
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm(formData)) {
      ...
      try {
        if (editMode) {
          await instance.put(`apply_now/update/${editingId}`, data, {
            headers: {
              Authorization: "Bearer " + accessToken,
          ...
          await instance.post("apply_now/add", data, {
            headers: {
              Authorization: "Bearer " + accessToken,
              "Content-Type": "multipart/form-data",
            },
          ...
          >
            <button
              ...
              onClick={async () => {
                ...
                try {
                  await instance.delete(`apply_now/isdelete/${id}`, {
                    headers: {
                      Authorization: `Bearer ${accessToken}`,
                      "Content-Type": "application/json",
                    },
